package swallow.com.model_zxing.android;
...
import swallow.com.model_zxing.R;
import swallow.com.model_zxing.bean.ZxingConfig;
import swallow.com.model_zxing.camera.CameraManager;
import swallow.com.model_zxing.common.Constant;
import swallow.com.model_zxing.decode.DecodeImgCallback;
import swallow.com.model_zxing.decode.DecodeImgThread;
import swallow.com.model_zxing.decode.ImageUtil;
import swallow.com.model_zxing.view.ViewfinderView;
...
public class CaptureActivity extends AppCompatActivity implements SurfaceHolder.Callback, View.OnClickListener {
    ...
    private LinearLayoutCompat ll_ocr;
    private CheckBox cb_ocr;
    ...
    private void initView() {
        ...
        ll_ocr = findViewById(R.id.ll_ocr);
        cb_ocr = findViewById(R.id.cb_ocr);
        ll_ocr.setOnClickListener(this);
        Constant.isOcr = cb_ocr.isChecked();
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.flashLightLayout) {
            ...
            cb_ocr.setChecked(!cb_ocr.isChecked());
            Constant.isOcr = cb_ocr.isChecked();
        }
    }
